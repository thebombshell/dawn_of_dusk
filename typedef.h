...
#ifndef DOD_TYPEDEF_H
#define DOD_TYPEDEF_H

typedef char dod_bool;
typedef char dod_char;
typedef char *dod_string;
typedef const char *dod_cstring;
